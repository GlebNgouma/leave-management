    ...
    public class LeaveRequestController : Controller
    {
        ...
        public ActionResult ApproveRequest(int id)
        {
            try
            {
                ...
                var allocation = _leaveAllocationRepo.GetLeaveAllocationsByEmployeeAndType(employeeId, leaveType);
        ...
        public ActionResult Create(CreateLeaveRequestViewVM model)
        {
            try
            {
